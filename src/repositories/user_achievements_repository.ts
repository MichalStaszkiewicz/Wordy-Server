...
export class UserAchievementsRepository {
    ...
    public static async getAllUserAchievements(profile: ProfileEntity): Promise<UserAchievementsEntity[]> {
    ...
    } public static async update(profile: ProfileEntity, id: number, achievement: Partial<UserAchievementsEntity>) {

        return dataSource.getRepository(UserAchievementsEntity).update({ profile: profile, id: id }, achievement);
